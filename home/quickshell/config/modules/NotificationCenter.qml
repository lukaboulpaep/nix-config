...
Item {
    ...
    readonly property bool menuOpen: Core.PopupManager.isOpen("notifications", root.popupScreen)
    ...
    MouseArea {
        ...
        onClicked: function (event) {
            ...
            Core.PopupManager.toggle("notifications", p.x + root.width / 2, p.y + Core.Theme.barMarginTop, root.popupScreen);
        }
    }
