...
QtObject {
    ...
    // Brightness ramp, dim -> bright (mdi-brightness-4..7). F00E1 is
    // mdi-brightness-auto (the circled "A"), so it does not belong here.
    readonly property var brightnessRamp: ["\udb80\udcdd", "\udb80\udcde", "\udb80\udcdf", "\udb80\udce0"]
    ...
    function forApp(appName) {
        ...
        if (n.indexOf("firefox") >= 0 || n.indexOf("zen") >= 0 || n.indexOf("chrom") >= 0 || n.indexOf("brave") >= 0 || n.indexOf("librewolf") >= 0 || n.indexOf("qutebrowser") >= 0)
            return web;
        ...
        if (n.indexOf("kitty") >= 0 || n.indexOf("ghostty") >= 0 || n.indexOf("alacritty") >= 0 || n.indexOf("foot") >= 0 || n.indexOf("term") >= 0 || n.indexOf("shell") >= 0 || n.indexOf("zsh") >= 0)
            return terminal;
